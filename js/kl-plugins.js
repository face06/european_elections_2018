    ...
    if (void 0 == jQuery) console.log("Jquery not included!"); else if (void 0 == Modernizr.video) console.log("Modernizr not included!"); else {
        ...
        jQuery.fn.extend({
            ...
            make_video: function () {
                ...
                !1 !== this.parameters.mp4 && (i += '<source src="' + this.parameters.mp4 + '" type="video/mp4"></source>'), !1 !== this.parameters.webm && (i += '<source src="' + this.parameters.webm + '" type="video/webm"></source>'), !1 !== this.parameters.ogg && (i += '<source src="' + this.parameters.ogg + '" type="video/ogg"></source>'), this.$video = t(i + "</video>").css({position: "absolute"}), this.$video_holder.append(this.$video), this.video = this.$video.get(0), !1 !== this.parameters.video_ratio && (this.resize_timeout = !1, t(window).resize(t.proxy(function () {
                ...
                var i = this.$video_holder.width(), t = this.$video_holder.height(), e = i,
                ...
                var i = t("html");
                if (this.$video = t('<div id="' + this.id + '_yt"></div>').appendTo(this.$video_holder).css({position: "absolute"}), this.youtube_ready = !1, 0 == o) {
                ...
                this.parameters.loop && (i.playlist = this.parameters.youtube), this.player = new YT.Player(this.id + "_yt", {
                    ...
                    events: {onReady: t.proxy(this.youtube_ready_fun, this)}
                })
                ...
                this.$video_holder.append('<div id="' + this.id + '_flash"></div>'), swfobject.embedSWF("flash/video.swf", this.id + "_flash", "100%", "100%", "9.0", null, i, {
                    ...
                    wmode: "transparent"
                }, {name: "background-video-swf"}, t.proxy(this.flash_callback, this))
            }, flash_callback: function (i) {
                this.video = t(i.target).get(0), this.parameters.muted && this.mute()
            }, make_image: function () {
                !1 !== this.parameters.fallback_image && (this.$img = t('<img src="' + this.parameters.fallback_image + '" alt=""/>').appendTo(this.$video_holder).css({position: "absolute"}), this.$img.ensureLoad(t.proxy(this.image_loaded, this)))
...
var swfobject = function () {
    ...
    function n(e) {
        if (typeof L.addEventListener != A) L.addEventListener("load", e, !1); else if (typeof k.addEventListener != A) k.addEventListener("load", e, !1); else if (typeof L.attachEvent != A) p(L, "onload", e); else if ("function" == typeof L.onload) {
            var t = L.onload;
            L.onload = function () {
                t(), e()
            }
    ...
    function a() {
        var e = k.getElementsByTagName("body")[0], t = k.createElement(N);
    ...
    function i() {
        ...
        if (e > 0) for (var t = 0; e > t; t++) {
            var n = F[t].id, a = F[t].callbackFn, i = {success: !1, id: n};
            if (0 < R.pv[0]) {
                var c = u(n);
                if (c) if (!v(F[t].swfVersion) || R.wk && 312 > R.wk) if (F[t].expressInstall && o()) {
                    ...
                    s(i, d, n, a)
                } else l(c), a && a(i); else h(n, !0), a && (i.success = !0, i.ref = r(n), a(i))
    ...
    function c(e) {
        var t = k.createElement("div");
        if (R.win && R.ie) t.innerHTML = e.innerHTML; else if ((e = e.getElementsByTagName(N)[0]) && (e = e.childNodes)) for (var n = e.length, a = 0; n > a; a++) 1 == e[a].nodeType && "PARAM" == e[a].nodeName || 8 == e[a].nodeType || t.appendChild(e[a].cloneNode(!0));
        return t
    }
    ...
    function d(e, t, n) {
        ...
        if (i) if (typeof e.id == A && (e.id = n), R.ie && R.win) {
            var r, o = "";
    ...
    var g, w, b, E, C, S, A = "undefined", N = "object", T = "application/x-shockwave-flash", I = "SWFObjectExprInst",
        L = window, k = document, j = navigator, B = !1, O = [function () {
            B ? a() : i()
        }], F = [], $ = [], x = [], M = !1, V = !1, P = !0, R = function () {
            var e = typeof k.getElementById != A && typeof k.getElementsByTagName != A && typeof k.createElement != A,
                t = j.userAgent.toLowerCase(), n = j.platform.toLowerCase(), a = n ? /win/.test(n) : /win/.test(t),
                n = n ? /mac/.test(n) : /mac/.test(t),
                t = /webkit/.test(t) ? parseFloat(t.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, i = !1,
                r = [0, 0, 0], o = null;
            if (typeof j.plugins != A && typeof j.plugins["Shockwave Flash"] == N) !(o = j.plugins["Shockwave Flash"].description) || typeof j.mimeTypes != A && j.mimeTypes[T] && !j.mimeTypes[T].enabledPlugin || (B = !0, i = !1, o = o.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), r[0] = parseInt(o.replace(/^(.*)\..*$/, "$1"), 10), r[1] = parseInt(o.replace(/^.*\.(.*)\s.*$/, "$1"), 10), r[2] = /[a-zA-Z]/.test(o) ? parseInt(o.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0); else if (typeof L.ActiveXObject != A) try {
                var s = new ActiveXObject("ShockwaveFlash.ShockwaveFlash");
                s && (o = s.GetVariable("$version")) && (i = !0, o = o.split(" ")[1].split(","), r = [parseInt(o[0], 10), parseInt(o[1], 10), parseInt(o[2], 10)])
            } catch (l) {
            }
            return {w3: e, pv: r, wk: t, ie: i, win: a, mac: n}
        }();
    return function () {
        ...
        registerObject: function (e, t, n, a) {
            ...
            var y = {success: !1, id: n};
            R.w3 && !(R.wk && 312 > R.wk) && e && n && a && i && r ? (h(n, !1), t(function () {
                a += "", i += "";
                var t = {};
                if (u && typeof u === N) for (var m in u) t[m] = u[m];
                if (t.data = e, t.width = a, t.height = i, m = {}, f && typeof f === N) for (var g in f) m[g] = f[g];
                if (c && typeof c === N) for (var w in c) m.flashvars = typeof m.flashvars != A ? m.flashvars + ("&" + w + "=" + c[w]) : w + "=" + c[w];
                if (v(r)) g = d(t, m, n), t.id == n && h(n, !0), y.success = !0, y.ref = g; else {
            ...
            if (t) {
                ...
                for (var t = t.split("&"), n = 0; n < t.length; n++) if (t[n].substring(0, t[n].indexOf("=")) == e) return m(t[n].substring(t[n].indexOf("=") + 1))
            }
            return ""
...
(function (e) {
    ...
    var t = window.console || function () {
        ...
        defaults: {
            ...
            markInvalid: function (n) {
                var r = e(n.element), i = e(n.errorID);
    ...
    }, r = n.defaults, i = r.patternLibrary, s = function (n) {
        return e.extend({
        ...
        isValid: function (t, n) {
            ...
            var r = true, i = [], s = e(this), o, u, a = [], f = function (t, n) {
                n.e = t;
                i.push(n)
            }, l = e.extend({}, t, n);
            n = n || {};
            ...
            s.trigger("formValidated", {valid: r, elements: i});
            return r
        }, validate: function (n) {
            var r = e(this), i = r.filter("[pattern]")[0] ? r.attr("pattern") : false,
                o = new RegExp("^(?:" + i + ")$"), u = null,
                ...
                f = n.errorClass, l = n.validClass, c = r.attr(n.errorAttribute) || false,
                h = c ? "#" + c.replace(/(:|\.|\[|\])/g, "\\$1") : false, p = false,
                d = s({element: this, valid: true}), v = e("<input required>"), m;
            ...
            if (p && !a) {
                ...
                if (!n.RODom) {
                    n.markValid({element: this, validity: d, errorClass: f, validClass: l, errorID: h, settings: n})
                }
            }
            if (!d.valid) {
                if (!n.RODom) {
                    n.markInvalid({element: this, validity: d, errorClass: f, validClass: l, errorID: h, settings: n})
                }
            }
            ...
            return this.each(function () {
                var e = {focusout: t.focusout, focusin: t.focusin, change: t.change, keyup: t.keyup},
                    n = {click: t.click}, r = {keyup: t.activeKeyup};
        ...
        var n, r = l.call(this), i;
        if (r.submit !== true) {
            return
        }
        n = e(this);
        i = n.h5Validate("allValid", {revalidate: r.validateOnSubmit === true});
        if (i !== true) {
            t.preventDefault();
            if (r.focusFirstInvalidElementOnSubmit === true) {
                var s = e(r.allValidSelectors, n).filter(function (t) {
                    return e(this).h5Validate("isValid", {revalidate: false}) !== true
                });
                s.first().focus()
            }
        }
        ...
        var i = e.extend({}, r, n, o), s = i.classPrefix + i.activeClass;
        return e.extend(i, {
            activeClass: s,
        ...
        e(this).trigger("instance", {"data-h5-instanceId": r})
    };
    e.h5Validate = {
        addPatterns: function (e) {
            var t = r.patternLibrary, n;
            for (n in e) {
...
;(function (e, t) {
    var n = function (e, t, n) {
        ...
        return function () {
            ...
            if (r) clearTimeout(r); else if (n) e.apply(s, o);
...
;(function (e) {
    ...
    var n = false;
    var r = false;
    var i = {interval: 250, force_process: false, appear_left_offset: 0, appear_top_offset: 0};
    var s = {};
    var o = e(window);
    var u;
